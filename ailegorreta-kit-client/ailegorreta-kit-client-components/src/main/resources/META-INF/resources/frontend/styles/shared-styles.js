...
$_documentContainer.innerHTML = `<dom-module id="lskit-app-layout-theme" theme-for="vaadin-app-layout">
  <template>
    <style>
      :host {
...
<dom-module id="lmasskit-login-theme" theme-for="vaadin-login-overlay-wrapper">
  <template>
    <style>
      [part="brand"] {
...
<!-- Themes for dialogs -->
<dom-module id="lmasskit-dialog-overlay-theme" theme-for="vaadin-dialog-overlay">
  <template>
    <style>
      :host([theme~="orders"]) {
...
<dom-module id="lmasskit-text-field-theme" theme-for="vaadin-text-field">
  <template>
    <style>
...
<dom-module id="lmasskit-grid-theme" theme-for="vaadin-grid">
  <template>
    <style>
      :host {
        width: 100%;
      ...
      :host([theme~="areas"]:not([reordering])) [part~="row"][selected] [part~="body-cell"]:not([part~="details-cell"]) {
        color: var(--lumo-error-text-color);
      }
      
      :host([theme~="posicion"]) [part~="cell"].success {
        color: var(--lumo-success-text-color);
      }
      
      :host([theme~="posicion"]) [part~="cell"].success-align-right {
        color: var(--lumo-success-text-color);
        text-align: right;
      }
      
      :host([theme~="posicion"]) [part~="cell"].error-align-right {
        color: var(--lumo-error-text-color);
        text-align: right;
      }
      
      :host([theme~="posicion"]) [part~="cell"].align-right {
        text-align: right;
      }
      .error {
      ...
      :host([theme~="posicion"]) [part~="header-cell"]:not(:empty):not([details-cell]) {
        height: 56px;
        color: var(--lumo-primary-text-color);
      }
